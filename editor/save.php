...
<button  class="btn btn-success btn-lg" name="btncancel" id="btncancel">Cancel</button>
    ...
    if($b){
      ...
      echo " <input type=text name=cid id=cid value= '".$row['CustomizedTshirt_id']."' / >";
    ...
    $sql = "INSERT into addtocart (img_path, quantity , CustomizedTshirt_id) values('$imgpaths', '$qty', $cid  )";
    $qry = mysqli_query($dbc, $sql);
