  ...
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <div id="tshirt" >
            <div id="shirtDiv" style="width: 530px; height: 550px; position: relative;  background-color: rgb(255, 255, 255);">
              <img src="images/longsleeves/male/mens_longsleeve_back.png" id="myimage" width="530px" height="550px"  ></img>
        ...
        <input type="hidden" name="longsleeves_back" id="longsleeves_back" value="Back"/>
        ...
        if(isset($_SERVER['uname']))
        {
          if(isset($_POST["btncomplete"]))
          {
            ...
            $position = $_POST['longsleeves_back'];
            $gender = $_POST['gender'];
