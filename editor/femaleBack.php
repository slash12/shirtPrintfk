      ...
      <div class="col-sm-6">
        ...
        <div id="tshirt">
          <div id="shirtDiv" style="width: 530px; height: 550px; position: relative;  background-color: rgb(255, 255, 255);">
            <img src="images/tshirt/female/back.png" id="myimage" width="530px" height="550px"  ></img>
        ...
        <input type="hidden" name="tshirtfemale_back" id="tshirtfemale_back" value="Back"/>
        ...
        if(isset($_POST["btncomplete"]))
        {
          ...
          $position = $_POST['tshirtfemale_back'];
          $gender = $_POST['gender'];
