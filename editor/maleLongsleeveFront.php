      ...
      <div class="row">
        <table>
          <tr>
            ...
            <td><a href="maleLongsleeveFront.php" onclick="msg();">Front</a></td>
            <td><a href="maleLongsleeveBack.php" onclick="msg();">Back</a></td>
          </tr>
        </table>
        ...
        <div class="col-sm-6">
          ...
          <div id="tshirt" >
            <div id="shirtDiv" style="width: 530px; height: 550px; position: relative;  background-color: rgb(255, 255, 255);">
              <img src="images/longsleeves/male/mens_longsleeve_front.png" id="myimage" width="530px" height="550px"  ></img>
        ...
        <input type="hidden" name="longsleeves" id="longsleeves" value="Longsleeves"/>
        <input type="hidden" name="longsleeves_front" id="longsleeves_front" value="Front"/>
        ...
        if(isset($_SERVER['uname']))
        {
          if(isset($_POST["btncomplete"]))
          {
            ...
            $category = $_POST['longsleeves'];
            $position = $_POST['longsleeves_front'];
            $gender = $_POST['gender'];
