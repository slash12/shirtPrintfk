  ...
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <div id="tshirt" >
            <div id="shirtDiv" style="width: 530px; height: 550px; position: relative;  background-color: rgb(255, 255, 255);">
              <img src="images/tshirt/male/back.png" id="myimage" width="530px" height="550px"  ></img>
        ...
        <input type="hidden" name="tshirt_back" id="tshirtmen_back" value="Back"/>
