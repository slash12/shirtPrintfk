...
<div class="row">
  ...
  <td><a href="maleTankTopFront.php" onclick="msg();">Front</a></td>
  <td><a href="maleTankTopBack.php" onclick="msg();">Back</a></td>
  </tr>
  </table>
...
<img src="images/tanktops/male/mens_tank_front.png" id="myimage" width="530px" height="550px"  ></img>
...
<!-- <center>
  ...
  <input type="hidden" name="tanktops" id="tanktops" value="Tank Tops"/>
  <input type="hidden" name="tanktops_front" id="tanktops_front" value="Front"/>
...
if(isset($_SERVER['uname']))
{
  if(isset($_POST["btncomplete"]))
  {
    ...
    $category = $_POST['tanktops'];
    $position = $_POST['tanktops_front'];
    $gender = $_POST['gender'];
