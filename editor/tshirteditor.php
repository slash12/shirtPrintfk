...
<script src="../js/editorjs/jquery-3.2.1.slim.min.js"></script>
<script src="../js/popper.js"></script>
<script src="../js/editorjs/bootstrap.min.js"></script>
...
<script type="text/javascript" src="../js/editorjs/html2canvas.js"></script>
...
var button2 = document.getElementById("btncomplete");
...
<div class="container">
  ...
  <td><a href="tshirteditor.php" onclick="msg();">Front</a></td>
  <td><a href="maleBack.php" onclick="msg();">Back</a></td>
  </tr>
  </table>
...
<img src="images/tshirt/male/front.png" id="myimage" width="530px" height="550px"  ></img>
...
<input type="hidden" name="hfcol2" id="hfcol2"/>
...
{
$color = $_POST['hfcol'];
$colorname = $_POST['hfcol2'];

$category = $_POST['tshirt'];
$position = $_POST['tshirt_front'];
$gender = $_POST['gender'];
...
$sql = "INSERT into addcustomizedtshirt(color, img_path, size, category, position,gender,uploadedimg,fontsize,fontfamily,fontcolor,color_name) values ('$color', '$file','$size', '$category','$position','$gender', '$filepath','$fontsize', '$fontfamily', '$fontcolor','$colorname')";
