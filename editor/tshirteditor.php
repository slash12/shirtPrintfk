  ...
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <input type="hidden" name="tshirt_front" id="tshirt_front" value="Front"/>
        ...
        if(isset($_POST["btncomplete"]))
        {
          ...
          else if  (empty($size))
          {
            ...
            if($success)
            {
              ...
              $sql = "INSERT into addcustomizedtshirt(color, img_path, size, category, position,gender,uploadedimg,fontsize,fontfamily,fontcolor,color_name,user_id) values ('$color', '$file','$size', '$category','$position','$gender', '$filepath','$fontsize', '$fontfamily', '$fontcolor','$color_name','$user_id') ";
